...
public class Rater extends CustomItem {
    ...
    /**
     * Creates a rater with an initial counter
     *
    ...
    /**
     * Creates a rater with a custom number of components
     *
    ...
    /**
     * Creates a rater component with a custom number of components and an
     * initial count
     *
    ...
    /**
     * Creates a rater with a default title and count
     *
    ...
    /**
     * Creates a rater with a title, count and number of components used to
     * display the count
     *
     * @param title
     * @param count
    ...
    /**
     * Creates a rater with a title, initial count and a custom rater layout
     *
     * @param title
     * @param count
     * @param raterLayout
    ...
    /**
     * Creates an initial rater with a title, count, no of components and a
     * custom rater layout
     *
     * @param title title for the rater
    ...
    /**
     * Checks whether the key 5 or center button was pressed and generates a key
     * event
     *
     * @param keyCode
     */
     ...
     */
    public void addRaterListener(RaterListener raterListener) {
     ...
     */
    public void removeRaterListener(RaterListener raterListener) {
    ...
    protected void triggerRaterEvent(RaterEvent raterEvent) {
        for (int raterListenersCounter = 0; raterListenersCounter < raterListeners.size();
                raterListenersCounter++) {
            ((RaterListener) raterListeners
                    .elementAt(raterListenersCounter))
                    .actionPerformed(raterEvent);
        }
    }

    /**
     * Determines and responds to traversal events for the rater component
     *
